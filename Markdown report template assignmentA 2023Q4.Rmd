...
- Start treatment by assigning users randomly to patch and vaping group. All the groups will slowly start consuming Nicotine, linearly increasing at the same rate for everybody till a pre-determined level through their respective sources of patch or vape.
...
The delta in body weight (Weight at end of experiment - weight at start of experiment).

## Participants
Describe which participants will recruit in the study and how they will be recruited

Users that do not consume Nicotine are ideal for this experiment because users that consume Nicotine can have developed resistance to Nicotine. They can be recruited through social media and flyers in different parts of the country and cities to attract a diverse group of participants. Intuitively, a few hundred participants should be sufficient, more are welcome.
