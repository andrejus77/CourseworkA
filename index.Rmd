...
The mean and SD for each candidate are: Trump = (-2, 3), Bernie = (2, 2) and Hillary = (0, 4)
...
intercept<-rbinom(100,1,0.5)
candidatesNominal <- factor(versionF, levels = c(0:2), labels = c("Donald Trump", "Hillary Clinton", "Bernie Sanders"))
...
```{r}
knitr::include_graphics("EXPERIMENTdesignQ2.png")
```
