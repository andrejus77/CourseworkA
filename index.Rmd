...
Because of the randomness in data generation either model m3PFake or m4PFake 
has the best fit because of the smallest WAIC value. The credibility interval 
for both of them in at least our test showed that shows that the coefficients 
a,b, c and d are non-null but they can lie close to 0, so it is possible that 
their range is null.
...
shows that all coefficients a,b,c and d are non null.
