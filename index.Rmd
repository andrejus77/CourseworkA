...
$version, portal \sim [0,1]$ [Predictor variables]
...
Model m4PFake has the best fit because of the smallest WAIC value.
The credibility interval for m4PFake shows that the coefficients a,b and
c are non-null.
...
this is the same as the previous result we got on synthetic data
where model 4 was better due to the interaction effect
